jQuery("#simulation")
  .on("click", ".s-db7fe671-828e-474f-9cf4-e0b42d825214 .click", function(event, data) {
  ...
  .on("focusin", ".s-db7fe671-828e-474f-9cf4-e0b42d825214 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
