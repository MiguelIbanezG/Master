jQuery("#simulation")
  .on("click", ".s-5166bae2-4a6c-441a-a8c3-5aec9aa58739 .click", function(event, data) {
  ...
  .on("focusin", ".s-5166bae2-4a6c-441a-a8c3-5aec9aa58739 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
