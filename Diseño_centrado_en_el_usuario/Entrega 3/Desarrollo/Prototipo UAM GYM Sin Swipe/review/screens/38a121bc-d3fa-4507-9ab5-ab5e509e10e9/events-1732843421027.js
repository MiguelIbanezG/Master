jQuery("#simulation")
  .on("click", ".s-38a121bc-d3fa-4507-9ab5-ab5e509e10e9 .click", function(event, data) {
  ...
  .on("keyup.jim", ".s-38a121bc-d3fa-4507-9ab5-ab5e509e10e9 .keyup", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    ...
    if(jFirer.is("#s-Input_text_1")) {
      cases = [
        ...
        },
        {
          "blocks": [
            {
              "condition": (data.which === 84 && data.ctrlKey === false && data.shiftKey === false && data.altKey === false),
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
  ...
  .on("focusin", ".s-38a121bc-d3fa-4507-9ab5-ab5e509e10e9 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
